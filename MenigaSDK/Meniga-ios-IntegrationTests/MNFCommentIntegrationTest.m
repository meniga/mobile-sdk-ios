...
-(void)testSaveComment {
    ...
    [MNFTransactionPage fetchWithTransactionFilter:filter page:nil transactionsPerPage:@10 completion:^( MNFTransactionPage * _Nullable page, NSError * _Nullable error) {
        ...
        MNFJob *job = [[page.transactions firstObject] postComment:@"testComment" withCompletion:^(NSError * _Nullable error) {
...
-(void)testDeleteComment {
    ...
    [MNFTransactionPage fetchWithTransactionFilter:filter page:nil transactionsPerPage:@10 completion:^( MNFTransactionPage * _Nullable page, NSError * _Nullable error) {
        ...
        [[page.transactions firstObject] postComment:@"testComment" withCompletion:^(NSError * _Nullable error) {
