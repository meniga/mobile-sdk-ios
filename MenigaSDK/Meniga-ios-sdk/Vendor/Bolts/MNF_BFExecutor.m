...
@interface MNF_BFExecutor ()

@property (nonatomic, copy) void(^block)(void(^block)());

@end

@implementation MNF_BFExecutor

#pragma mark - Executor methods

+ (instancetype)defaultExecutor {
    static MNF_BFExecutor *defaultExecutor = NULL;
...
+ (instancetype)immediateExecutor {
    static MNF_BFExecutor *immediateExecutor = NULL;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
...
+ (instancetype)mainThreadExecutor {
    static MNF_BFExecutor *mainThreadExecutor = NULL;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
