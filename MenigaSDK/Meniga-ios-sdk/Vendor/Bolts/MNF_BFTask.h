 ...
 */
extern NSString *const MNF_BFTaskErrorDomain;

/*!
 An exception that is thrown if there was multiple exceptions on <BFTask taskForCompletionOfAllTasks:>.
 */
extern NSString *const MNF_BFTaskMultipleExceptionsException;

@class MNF_BFExecutor;
@class MNF_BFTask;

/*!
 A block that can act as a continuation for a task.
 */
typedef id(^MNF_BFContinuationBlock)(MNF_BFTask *task);
...
/**
 The metadata incorporated for a successful task.
 */
