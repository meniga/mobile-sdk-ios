...
- (void)setUp {
    ...
    [MNFDemoUser startSynchronizationWithWaitTime:@1000
                                       completion:^(MNFSynchronization *sync, NSError *error){
...
- (void)testTransactionPageWithEmptyFilterAndTenTransactionsPerPage {
    ...
    MNFJob *job = [MNFTransactionPage fetchWithTransactionFilter:[[MNFTransactionFilter alloc] init]
                                                            page:nil
                                             transactionsPerPage:[NSNumber numberWithInt:10]
                                                      completion:^(MNFTransactionPage *transPage, NSError *error) {
...
- (void)testTransactionPageWithEmptyFilterAndTwentyTransactionsPerPage {
    ...
    MNFJob *job = [MNFTransactionPage fetchWithTransactionFilter:[[MNFTransactionFilter alloc] init]
                                             ...
                                             transactionsPerPage:@20
                                                      completion:^(MNFTransactionPage *page, NSError *error) {
...
- (void)testTransactionPageAppendNextPage {
    ...
    MNFJob *job = [MNFTransactionPage
        fetchWithTransactionFilter:[[MNFTransactionFilter alloc] init]
                              page:@1
