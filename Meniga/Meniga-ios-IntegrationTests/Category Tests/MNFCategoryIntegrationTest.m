...
- (void)testFetchSystemCategories {
    ...
    MNFJob *job = [MNFCategory fetchSystemCategoriesWithCulture:nil completion:^(NSArray <MNFCategory *> *categories, NSError *error) {
...
-(void)testFetchUserCreatedCategories {
    ...
    MNFJob *job = [MNFCategory createUserParentCategoryWithName:@"New Category" isFixedExpense:@1 categoryType:kMNFCategoryTypeExcluded completion:^(MNFCategory *newCategory, NSError *secondError) {
        ...
        [MNFCategory fetchUserCreatedCategoriesWithCulture:nil completion:^(NSArray *userCreatedCategories, NSError *thirdError) {
...
-(void)testFetchAllCategories {
    ...
    [MNFCategory createUserParentCategoryWithName:@"New category" isFixedExpense:@0 categoryType:kMNFCategoryTypeIncome completion:^(MNFCategory *newCategory, NSError *firstError) {
        ...
        MNFJob *job = [MNFCategory fetchCategoriesWithCulture:nil completion:^(NSArray *allCategories, NSError *secondError) {
        ...
        [job handleCompletion:^(NSArray *allCategories, id  _Nullable metaData, NSError * _Nullable secondError) {
...
-(void)testFetchWithIdNewlyCreatedParentCategory {
    ...
    MNFJob *job = [MNFCategory createUserParentCategoryWithName:@"New name" isFixedExpense:@1 categoryType:kMNFCategoryTypeIncome completion:^(MNFCategory *newCategory, NSError *error) {
        
        XCTAssertEqualObjects(newCategory.name, @"New name");
        XCTAssertNil(error);
        
        MNFJob *secondJob = [MNFCategory fetchWithId:newCategory.identifier culture:nil completion:^(MNFCategory *fetchedCategory, NSError *error) {
            
            XCTAssertEqualObjects(fetchedCategory.name, newCategory.name);
            XCTAssertEqualObjects(fetchedCategory.isFixedExpenses, newCategory.isFixedExpenses);
            XCTAssertEqual(fetchedCategory.categoryTypeId, newCategory.categoryTypeId);
            XCTAssertEqualObjects(fetchedCategory.parentCategoryId, newCategory.parentCategoryId);
        ...
        [secondJob handleCompletion:^(MNFCategory *fetchedCategory, id  _Nullable metaData, NSError * _Nullable error) {
...
-(void)testFetchWithIdSystemTransaction {
    ...
    [MNFCategory fetchSystemCategoriesWithCulture:nil completion:^(NSArray *systemCategories, NSError *error) {
        ...
        MNFJob *job = [MNFCategory fetchWithId:firstCategory.identifier culture:nil completion:^(MNFCategory *fetchedCategory, NSError *error) {
            ...
            XCTAssertEqualObjects(fetchedCategory.isFixedExpenses, firstCategory.isFixedExpenses);
            XCTAssertEqualObjects(fetchedCategory.parentCategoryId, firstCategory.parentCategoryId);
        ...
        [job handleCompletion:^(MNFCategory *fetchedCategory, id  _Nullable metaData, NSError * _Nullable error) {
...
-(void)testFetchCategoryTree {
    ...
    MNFJob *job = [MNFCategory fetchCategoryTreeWithCulture:nil completion:^(NSArray *categoryTree, NSError *error) {
...
-(void)testCreateUserCreatedParentCategory{
    ...
    MNFJob *job = [MNFCategory createUserParentCategoryWithName:@"New Category" isFixedExpense:@1 categoryType:kMNFCategoryTypeExpenses completion:^(MNFCategory *newCategory, NSError *secondError) {
...
-(void)testCreateUserCreatedCategoryWithParent {
    ...
    [MNFCategory fetchCategoriesWithCulture:nil completion:^(NSArray *categories, NSError *error) {
        ...
        [MNFCategory fetchCategoryTypesWithCompletion:^(NSArray *categoryTypes, NSError *secondError) {
            ...
            MNFJob *job = [MNFCategory createUserChildCategoryWithName:@"Epic name" isFixedExpense:@0 parentCategoryType:category.categoryTypeId parentCategoryId:category.identifier completion:^(MNFCategory *newCategory, NSError *thirdError) {
...
-(void)testSaveCategory {
    ...
    [MNFCategory createUserParentCategoryWithName:@"New Category" isFixedExpense:@1 categoryType:kMNFCategoryTypeSavings completion:^(MNFCategory *createdCategory, NSError *secondError) {
        ...
        [createdCategory saveWithCompletion:^(NSError *thirdError) {
            ...
            MNFJob *job = [MNFCategory fetchWithId:createdCategory.identifier culture:nil completion:^(MNFCategory *updatedCategory, NSError *fourthError) {
            ...
            [job handleCompletion:^(MNFCategory *updatedCategory, id  _Nullable metaData, NSError * _Nullable error) {
...
-(void)testRefreshCategory {
    ...
    [MNFCategory createUserParentCategoryWithName:@"Categooory" isFixedExpense:@1 categoryType:kMNFCategoryTypeSavings completion:^(MNFCategory *newCategory, NSError *error) {
...
-(void)testDeleteCategory {
    ...
    [MNFCategory createUserParentCategoryWithName:@"Cool Category" isFixedExpense:@1 categoryType:kMNFCategoryTypeExcluded completion:^(MNFCategory *newCategory, NSError *secondError) {
        ...
        MNFJob *job = [newCategory deleteCategoryWithConnectedRules:[NSNumber numberWithBool:NO] moveTransactionsToNewCategoryId:nil completion:^(NSError *thirdError) {
            ...
            MNFJob *secondJob = [MNFCategory fetchWithId:newCategory.identifier culture:nil completion:^(MNFCategory *fetchedCategory, NSError *fourthError) {
            ...
            [secondJob handleCompletion:^(MNFCategory *category, id  _Nullable metaData, NSError * _Nullable error) {
