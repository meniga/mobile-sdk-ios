               ...
               transactionsPerPage:@1000
                        completion:^(MNFTransactionPage *_Nullable page, NSError *_Nullable error) {
                            [[page.transactions firstObject]
                                   postComment:@"testComment with #hashtag"
                                withCompletion:^(NSError *_Nullable error) {
                                    XCTAssertNil(error);

                                    MNFJob *job = [MNFTag fetchTagsWithCompletion:^(NSArray<MNFTag *> *_Nullable tags,
                                        ...
                                        [MNFTag fetchWithId:[tags firstObject].identifier
                                    ...
                                    [job handleCompletion:^(NSArray<MNFTag *> *_Nullable tags,
               ...
               transactionsPerPage:@1000
                        completion:^(MNFTransactionPage *_Nullable page, NSError *_Nullable error) {
                            [[page.transactions firstObject]
                                ...
                                withCompletion:^(NSError *_Nullable error) {
                                    MNFJob *job = [MNFTag
                                        fetchPopularTagsWithCount:@10
                                                       completion:^(NSArray<MNFTag *> *_Nullable tags,
                                                                    NSError *_Nullable error) {
                                                           XCTAssertNil(error);
                                                           XCTAssertNotNil(tags);
