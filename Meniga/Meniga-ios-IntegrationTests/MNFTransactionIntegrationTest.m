        ...
        fetchWithTransactionFilter:filter
               ...
               transactionsPerPage:@10
                        completion:^(MNFTransactionPage *_Nullable page, NSError *_Nullable error) {
                            ...
                            MNFJob *job = [MNFTransaction
                                fetchWithId:[page.transactions firstObject].identifier
                                 completion:^(MNFTransaction *_Nullable transaction, NSError *_Nullable error) {
                                     XCTAssertNil(error);
                            ...
                            [job handleCompletion:^(MNFTransaction *_Nullable transaction,
               ...
               transactionsPerPage:@10
                        completion:^(MNFTransactionPage *_Nullable page, NSError *_Nullable error) {
                            ...
                            MNFJob *job = [[page.transactions firstObject]
                                fetchSplitWithCompletion:^(NSArray<MNFTransaction *> *_Nullable transactions,
                                                           NSError *_Nullable error) {
                                    XCTAssertNil(error);
                            ...
                            [job handleCompletion:^(NSArray<MNFTransaction *> *_Nullable transactions,
                                                    id _Nullable metaData,
                                                    NSError *_Nullable error) {
                                XCTAssertNotNil(transactions);
                                XCTAssertTrue(transactions.count == 1);
...
- (void)testCreateAndDeleteTransaction {
    ...
    MNFJob *job = [MNFTransaction
        createTransactionWithDate:date
                             text:@"text"
                           amount:@10
                       categoryId:@10
                        setAsRead:@YES
                       completion:^(MNFTransaction *_Nullable transaction, NSError *_Nullable error) {
                           ...
                           MNFJob *secondJob =
                               [transaction deleteTransactionWithCompletion:^(NSError *_Nullable error) {
                                   XCTAssertNil(error);
...
- (void)testDeleteMultipleTransactions {
    ...
    [MNFTransaction createTransactionWithDate:[NSDate date]
                                         text:@"new trans"
                                       amount:@10
                                   categoryId:@81
                                    setAsRead:@0
                                   completion:^(MNFTransaction *transaction, NSError *error) {
                                       XCTAssertNil(error);

                                       MNFJob *job =
                                           [MNFTransaction deleteTransactions:@[transaction]
                                                               withCompletion:^(NSError *_Nullable secondError) {
        ...
        fetchWithTransactionFilter:filter
               ...
               transactionsPerPage:@10
                        completion:^(MNFTransactionPage *_Nullable page, NSError *_Nullable error) {
                            ...
                            MNFJob *job = [[page.transactions firstObject] saveWithCompletion:^(
                                                                               NSError *_Nullable error) {
                                XCTAssertNil(error);
        ...
        fetchWithTransactionFilter:filter
               ...
               transactionsPerPage:@10
                        completion:^(MNFTransactionPage *_Nullable page, NSError *_Nullable error) {
                            ...
                            MNFJob *job = [[page.transactions firstObject] refreshWithCompletion:^(
                                                                               NSError *_Nullable error) {
                                XCTAssertNil(error);
        ...
        fetchWithTransactionFilter:filter
               ...
               transactionsPerPage:@10
                        completion:^(MNFTransactionPage *_Nullable page, NSError *_Nullable error) {
                            ...
                            MNFJob *job = [[page.transactions firstObject]
                                splitTransactionWithAmount:splitAmount
                                                categoryId:[page.transactions firstObject].categoryId
                                                      text:@"split"
                                                 isFlagged:NO
                                                completion:^(MNFTransaction *_Nullable transaction,
                                                    ...
                                                    XCTAssertNil(error);
                                                    XCTAssertNotNil(transaction);
                                                    XCTAssertEqualObjects([page.transactions firstObject].amount,
                                                                          transaction.amount);
...
- (void)testRecategorizeTransactions {
    ...
    MNFJob *job = [MNFTransaction recategorizeWithTexts:@[@"T-Mobile UK"]
                                             unreadOnly:NO
                                             useSubText:NO
                                             markAsRead:NO
                                             categoryId:@81
