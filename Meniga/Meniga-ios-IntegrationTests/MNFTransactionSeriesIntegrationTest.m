...
-(void)testFetchTransactionSeries {
    ...
    MNFJob *job = [MNFTransactionSeries fetchTransactionSeriesWithTransactionSeriesFilter:seriesFilter withCompletion:^(NSArray<MNFTransactionSeries *> * _Nullable result, NSError * _Nullable error) {
        XCTAssertNil(error);
