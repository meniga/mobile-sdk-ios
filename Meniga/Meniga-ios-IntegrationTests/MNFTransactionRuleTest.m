...
- (void)testCreateTransactionRule {
    ...
    MNFJob *job =
        [MNFTransactionRule createRuleWithName:@"name"
                                  textCriteria:@"criteria"
                      textCriteriaOperatorType:@0
                         dateMatchTypeCriteria:@0
                             daysLimitCriteria:nil
                       amountLimitTypeCriteria:nil
                       amountLimitSignCriteria:nil
                                amountCriteria:nil
                       accountCategoryCriteria:nil
                                  acceptAction:@0
                              monthShiftAction:nil
                                  removeAction:nil
                                    textAction:@"some text action"
                                 commentAction:@"some comment action"
                              categoryIdAction:@81
                                  splitActions:nil
                                    flagAction:nil
                               applyOnExisting:@YES
                                    completion:^(MNFTransactionRule *_Nullable rule, NSError *_Nullable error) {
...
- (void)testCreateChangeEverythingAndSaveAndFetch {
    ...
    [MNFTransactionRule
              createRuleWithName:@"rule"
                    textCriteria:@"criteria"
        textCriteriaOperatorType:@0
           dateMatchTypeCriteria:@0
               daysLimitCriteria:@0
         amountLimitTypeCriteria:@0
         amountLimitSignCriteria:@0
                  amountCriteria:@0
         accountCategoryCriteria:@"accountCategoryCriteria"
                    acceptAction:@0
                monthShiftAction:@0
                    removeAction:@0
                      textAction:@"action"
                ...
                categoryIdAction:@81
                    splitActions:@[[MNFTransactionSplitAction transactionSplitActionWithRatio:@0.1
                                                                                       amount:@100
                                                                                   categoryId:@81]]
                      flagAction:@0
                 applyOnExisting:@YES
                      completion:^(MNFTransactionRule *_Nullable rule, NSError *_Nullable error) {
                          ...
                          [rule
                              saveAndApplyOnExisting:@YES
                                          completion:^(NSError *error) {
                                              MNFJob *job = [MNFTransactionRule
                                                  fetchRuleWithId:rule.identifier
                                                       completion:^(MNFTransactionRule *fetchedRule, NSError *error) {
                                                           XCTAssertEqualObjects(rule.name, fetchedRule.name);
                                                           XCTAssertEqualObjects(rule.textCriteria,
                                                                                 fetchedRule.textCriteria);
                                                           XCTAssertEqualObjects(rule.textCriteriaOperatorType,
                                                                                 fetchedRule.textCriteriaOperatorType);
                                                           XCTAssertEqualObjects(rule.dateMatchTypeCriteria,
                                                                                 fetchedRule.dateMatchTypeCriteria);
                                                           XCTAssertEqualObjects(rule.daysLimitCriteria,
                                                                                 fetchedRule.daysLimitCriteria);
                                                           XCTAssertEqualObjects(rule.amountLimitTypeCriteria,
                                                                                 fetchedRule.amountLimitTypeCriteria);
                                                           XCTAssertEqualObjects(rule.amountLimitSignCriteria,
                                                                                 fetchedRule.amountLimitSignCriteria);
                                                           XCTAssertEqualObjects(rule.amountCriteria,
                                                                                 fetchedRule.amountCriteria);
                                                           XCTAssertEqualObjects(rule.accountCategoryCriteria,
                                                                                 fetchedRule.accountCategoryCriteria);
                                                           XCTAssertEqualObjects(rule.acceptAction,
                                                                                 fetchedRule.acceptAction);
                                                           XCTAssertEqualObjects(rule.monthShiftAction,
                                                                                 fetchedRule.monthShiftAction);
                                                           XCTAssertEqualObjects(rule.removeAction,
                                                                                 fetchedRule.removeAction);
                                                           XCTAssertEqualObjects(rule.textAction,
                                                                                 fetchedRule.textAction);
                                                           XCTAssertEqualObjects(rule.commentAction,
                                                                                 fetchedRule.commentAction);
                                                           XCTAssertEqualObjects(rule.categoryIdAction,
                                                                                 fetchedRule.categoryIdAction);
                                                           XCTAssertEqualObjects(rule.categoryIdAction,
                                                                                 fetchedRule.categoryIdAction);
                                                           XCTAssertEqualObjects(
                                                               rule.splitActions.firstObject.identifier,
                                                               fetchedRule.splitActions.firstObject.identifier);
                                                           XCTAssertEqualObjects(
                                                               rule.splitActions.firstObject.transactionRuleId,
                                                               fetchedRule.splitActions.firstObject.transactionRuleId);
                                                           XCTAssertEqualObjects(
                                                               rule.splitActions.firstObject.ratio,
                                                               fetchedRule.splitActions.firstObject.ratio);
                                                           XCTAssertEqualObjects(
                                                               rule.splitActions.firstObject.amount,
                                                               fetchedRule.splitActions.firstObject.amount);
                                                           XCTAssertEqualObjects(
                                                               rule.splitActions.firstObject.categoryId,
                                                               fetchedRule.splitActions.firstObject.categoryId);
                                                           XCTAssertEqualObjects(rule.flagAction,
                                                                                 fetchedRule.flagAction);
                                              ...
                                              [job handleCompletion:^(MNFTransactionRule *fetchedRule,
                                                  ...
                                                  XCTAssertEqualObjects(
                                                      rule.splitActions.firstObject.transactionRuleId,
                                                      fetchedRule.splitActions.firstObject.transactionRuleId);
                                                  XCTAssertEqualObjects(rule.splitActions.firstObject.ratio,
                                                                        fetchedRule.splitActions.firstObject.ratio);
                                                  XCTAssertEqualObjects(rule.splitActions.firstObject.amount,
                                                                        fetchedRule.splitActions.firstObject.amount);
                                                  XCTAssertEqualObjects(
                                                      rule.splitActions.firstObject.categoryId,
                                                      fetchedRule.splitActions.firstObject.categoryId);
                              ...
                              saveAndApplyOnExisting:@NO
                                          completion:^(NSError *_Nullable error) {
                                              ...
                                              MNFJob *job = [MNFTransactionRule
                                                  fetchRuleWithId:rule.identifier
                                                       completion:^(
                                                           MNFTransactionRule *_Nullable fetchedTransactionRule,
                                                           NSError *_Nullable error) {
                                                           XCTAssertEqualObjects(rule.identifier,
                                                                                 fetchedTransactionRule.identifier);
                                                           // MARK: Updating the name parameter does not do anything, backend took a dumper on that one
                                                           XCTAssertEqualObjects(rule.name,
                                                                                 fetchedTransactionRule.name);
                                                           XCTAssertEqualObjects(rule.amountCriteria,
                                                                                 fetchedTransactionRule.amountCriteria);
                                                           XCTAssertEqualObjects(rule.textCriteria,
                                                                                 fetchedTransactionRule.textCriteria);
                                                           XCTAssertEqualObjects(
                                                               rule.textCriteriaOperatorType,
                                                               fetchedTransactionRule.textCriteriaOperatorType);
                                                           XCTAssertEqualObjects(
                                                               rule.dateMatchTypeCriteria,
                                                               fetchedTransactionRule.dateMatchTypeCriteria);
                                                           XCTAssertEqualObjects(rule.acceptAction,
                                                                                 fetchedTransactionRule.acceptAction);
                                                           XCTAssertEqualObjects(rule.textAction,
                                                                                 fetchedTransactionRule.textAction);
                                                           XCTAssertEqualObjects(rule.commentAction,
                                                                                 fetchedTransactionRule.commentAction);
                                                           XCTAssertEqualObjects(
                                                               rule.categoryIdAction,
                                                               fetchedTransactionRule.categoryIdAction);
...
- (void)testCreateTwoRulesFetchMultipleRulesAndDelete {
    ...
    MNFJob *job = [MNFTransactionRule
              createRuleWithName:@"first rule"
                    textCriteria:@"text criteria one"
        textCriteriaOperatorType:@0
           dateMatchTypeCriteria:@0
               daysLimitCriteria:@1
         amountLimitTypeCriteria:@100
         amountLimitSignCriteria:@1
                  amountCriteria:@1000
         accountCategoryCriteria:@"account criteria"
                    acceptAction:@0
                monthShiftAction:@1
                    removeAction:nil
                      textAction:nil
                   commentAction:nil
                categoryIdAction:nil
                    splitActions:nil
                      flagAction:nil
                 applyOnExisting:@NO
                      completion:^(MNFTransactionRule *ruleOne, NSError *_Nullable error) {
                          ...
                          MNFJob *secondJob = [MNFTransactionRule
                                    createRuleWithName:@"secondRule"
                                          textCriteria:nil
                              textCriteriaOperatorType:nil
                                 dateMatchTypeCriteria:nil
                                     daysLimitCriteria:nil
                               amountLimitTypeCriteria:nil
                               amountLimitSignCriteria:nil
                                        amountCriteria:nil
                               accountCategoryCriteria:nil
                                      ...
                                      categoryIdAction:@1
                                          splitActions:nil
                                            flagAction:@1
                                       applyOnExisting:@YES
                                            completion:^(MNFTransactionRule *ruleTwo, NSError *_Nullable error) {
                                                ...
                                                MNFJob *thirdJob = [MNFTransactionRule
                                                    fetchRulesWithCompletion:^(NSArray<MNFTransactionRule *> *rules,
                                                                               NSError *error) {
                                                        ...
                                                        MNFJob *fourthJob = [rules.firstObject
                                                            deleteRuleWithCompletion:^(NSError *error) {
                                                        ...
                                                        [fourthJob handleCompletion:^(id _Nullable result,
                                                                                      id _Nullable metadata,
                                                                                      NSError *_Nullable error) {
                                                            XCTAssertTrue(rules.firstObject.isDeleted == YES);
                                                ...
                                                [thirdJob handleCompletion:^(NSArray<MNFTransactionRule *> *rules,
                                                                             id _Nullable metadata,
                                                                             NSError *_Nullable error) {
                                                    XCTAssertNotNil(rules);
                                                    XCTAssertTrue(rules.count == 2);
                          ...
                          [secondJob handleCompletion:^(
                                         MNFTransactionRule *ruleTwo, id _Nullable metadata, NSError *_Nullable error) {
                              XCTAssertEqualObjects(ruleTwo.name, @"secondRule");
