...
-(void)testChangeCulture {
    ...
    [MNFUser fetchUsersWithCompletion:^(NSArray<MNFUser *> * _Nullable users, NSError * _Nullable error) {
        ...
        MNFJob *job = [[users firstObject] changeCulture:@"is-IS" withCompletion:^(NSError * _Nullable error) {
...
-(void)testUserMetadata {
    ...
    [MNFUser fetchUsersWithCompletion:^(NSArray<MNFUser *> * _Nullable users, NSError * _Nullable error) {
        ...
        [[users firstObject] updateMetaDataForKey:@"metadataKey" value:@"metadataValue" completion:^(NSError * _Nullable error) {
        
            XCTAssertNil(error);
            
            MNFJob *job = [[users firstObject] fetchMetaDataForKeys:@"metadataKey" completion:^(NSArray<NSDictionary *> * _Nullable metadatas, NSError * _Nullable error) {
            ...
            [job handleCompletion:^(NSArray<NSDictionary *> * _Nullable metadatas, id  _Nullable meta, NSError * _Nullable error) {
