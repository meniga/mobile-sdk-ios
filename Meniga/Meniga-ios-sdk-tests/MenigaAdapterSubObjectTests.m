...
-(void)testSubPropertySerializationNoOption {
    ...
    MNFAdapterMainTestObject *mainObject = [MNFAdapterMainTestObject adapterMainTestObjectWithTransactionId:@1 transactionInfo:@"info" comment:[MNFAdapterSubTestObject adapterSubTestObjectWithCommentId:@43 commentTitle:@"comment"] allComments:@[ [MNFAdapterSubTestObject adapterSubTestObjectWithCommentId:@32 commentTitle:@"another comment"], [MNFAdapterSubTestObject adapterSubTestObjectWithCommentId:@18 commentTitle:@"yet another comment"] ]];
    ...
    NSArray *commentsArray = @[ @{ @"commentId" : @32, @"commentTitle" : @"another comment" }, @{ @"commentId" : @18, @"commentTitle" : @"yet another comment" } ];
...
-(void)testSubPropertySerializationFirstLetterLowercaseOption {
    ...
    MNFAdapterMainFirstUppercaseTestObj *firstUpp = [MNFAdapterMainFirstUppercaseTestObj adapterMainFirstUppercaseTestObjWithTransactionId:@23 transactionInfo:@"A lot of info" comment:[MNFAdapterSubFirstUppercaseTestObject adapterSubFirstUppercaseTestObjWithCommentId:@13 commentTitle:@"cool comment"] allComments:@[ [MNFAdapterSubFirstUppercaseTestObject adapterSubFirstUppercaseTestObjWithCommentId:@93 commentTitle:@"lax comment"], [MNFAdapterSubFirstUppercaseTestObject adapterSubFirstUppercaseTestObjWithCommentId:@71 commentTitle:@"worse comment"] ]];
    
    NSDictionary *dict = [MNFJsonAdapter JSONDictFromObject:firstUpp option:kMNFAdapterOptionFirstLetterLowercase error:nil];
...
-(void)testSubPropertySerializationLowercaseOption {
    ...
    MNFAdapterMainUppercaseTestObject *uppercaseObj = [MNFAdapterMainUppercaseTestObject adapterMainUppercaseTestObjWithTransactionId:@7 transactionInfo:@"too much infooo" comment:[MNFAdapterSubUppercaseTestObject adapterSubUppercaseTestObjectWithCommentId:@64 commentTitle:@"a comment title"] allComments:@[ [MNFAdapterSubUppercaseTestObject adapterSubUppercaseTestObjectWithCommentId:@56 commentTitle:@"a title"], [MNFAdapterSubUppercaseTestObject adapterSubUppercaseTestObjectWithCommentId:@47 commentTitle:@"cool title"] ]];
...
-(void)testSubPropertySerializationFirstUppercaseOptionDelegateMapping {
    ...
    NSDictionary *dict = [MNFJsonAdapter JSONDictFromObject:mainObject delegate:[[MNFAdapterSubPropertyFirstUppercaseOptionDelegate alloc] init] option:kMNFAdapterOptionFirstLetterUppercase error:nil];
    XCTAssertTrue(dict.allKeys.count == 4);
...
-(void)testSubPropertySerializationUppercaseOptionDelegateMapping {
    ...
    NSDictionary *dict = [MNFJsonAdapter JSONDictFromObject:mainObject delegate:[[MNFAdapterSubPropertyUppercaseOptionDelegate alloc] init] option:kMNFAdapterOptionUppercase error:nil];
    XCTAssertTrue(dict.allKeys.count == 4);
...
-(void)testSubPropertySerializationDelegateNoOption {
    ...
    MNFMainAdapterDelegateTestObj *delegateObj = [MNFMainAdapterDelegateTestObj adapterDelegateTestObjWithTransactionId:@9 transactionInfo:@"disgusting info" comment:[MNFAdapterSubTestDelegateObj adapterSubTestDelegateObjWithCommentId:@18 commentTitle:@"the comment title"] allComments:@[ [MNFAdapterSubTestDelegateObj adapterSubTestDelegateObjWithCommentId:@40 commentTitle:@"sub test object one"], [MNFAdapterSubTestDelegateObj adapterSubTestDelegateObjWithCommentId:@107 commentTitle:@"sub test object two"] ]];
...
-(void)testSubPropertySerializationDelegateFirstLowercaseOption {
    ...
    MNFMainAdapterDelegateFirstUppercaseTestObj *delegateObj = [MNFMainAdapterDelegateFirstUppercaseTestObj adapterDelegateFirstUppercaseTestObjWithTransactionId:@56 transactionInfo:@"Chuck norris!" comment:[MNFAdapterSubDelegateFirstUppercaseTestObj adapterSubDelegateFirstUppercaseTestObjWithCommentId:@234 commentTitle:@"chuck norris rules"] allComments:@[ [MNFAdapterSubDelegateFirstUppercaseTestObj adapterSubDelegateFirstUppercaseTestObjWithCommentId:@1123 commentTitle:@"Chuck Norris eats desks"], [MNFAdapterSubDelegateFirstUppercaseTestObj adapterSubDelegateFirstUppercaseTestObjWithCommentId:@932 commentTitle:@"Chuck Norris has his own gravity field"] ]];
    
    NSDictionary *dict = [MNFJsonAdapter JSONDictFromObject:delegateObj option:kMNFAdapterOptionFirstLetterLowercase error:nil];
...
-(void)testSubPropertySerializationDelegateLowercaseOption {
    ...
    MNFMainAdapterDelegateUppercaseTestObj *delegateObj = [MNFMainAdapterDelegateUppercaseTestObj adapterDelegateUppercaseTestObjWithTransactionId:@94 transactionInfo:@"Trump running for president" comment:[MNFAdapterSubDelegateUppercaseTestObj adapterSubDelegateUppercaseTestObjWithCommentId:@84 commentTitle:@"he cannot run for shit"] allComments:@[ [MNFAdapterSubDelegateUppercaseTestObj adapterSubDelegateUppercaseTestObjWithCommentId:@678 commentTitle:@"trump it up!"], [MNFAdapterSubDelegateUppercaseTestObj adapterSubDelegateUppercaseTestObjWithCommentId:@35 commentTitle:@"trump should definitely not be president"] ]];
...
-(void)testSubPropertySerializationDelegateFirstUppercaseOptionDelegateMapping {
    ...
    NSDictionary *dict = [MNFJsonAdapter JSONDictFromObject:delegateObj delegate:[[MNFAdapterSubPropertyMappingDelegateFirstUppercaseDelegate alloc] init] option:kMNFAdapterOptionFirstLetterUppercase error:nil];
...
-(void)testSubPropertySerializationDelegateUppercaseOptionDelegateMapping {
    ...
    NSDictionary *dict = [MNFJsonAdapter JSONDictFromObject:delegateObj delegate:[[MNFAdapterSubPropertyMappingDelegateUppercaseDelegate alloc] init] option:kMNFAdapterOptionUppercase error:nil];
...
-(void)testSingleSubPropertyDeserializationNoOption {
    ...
    MNFAdapterMainTestObject *mainTestObject = [MNFJsonAdapter objectOfClass:[MNFAdapterMainTestObject class] jsonDict:[self dictForFileName:@"JsonSubObjectTest" ofType:@"json"] option:kMNFAdapterOptionNoOption error:nil];
...
-(void)testSingleSubPropertyDeserializationFirstLowercaseOption {
    ...
    MNFAdapterMainFirstUppercaseTestObj *mainTestObject = [MNFJsonAdapter objectOfClass:[MNFAdapterMainFirstUppercaseTestObj class] jsonDict:[self dictForFileName:@"JsonSubObjectTest" ofType:@"json"] option:kMNFAdapterOptionFirstLetterLowercase error:nil];
...
-(void)testSingleSubPropertyDeserializationLowercaseOption {
    ...
    MNFAdapterMainUppercaseTestObject *maintTestObject = [MNFJsonAdapter objectOfClass:[MNFAdapterMainUppercaseTestObject class] jsonDict:[self dictForFileName:@"JsonSubObjectLowercaseTest" ofType:@"json"] option:kMNFAdapterOptionLowercase error:nil];
...
-(void)testSingleSubPropertyDeserializationFirstUppercaseOptionDelegateMapping {
    ...
    MNFAdapterMainTestObject *mainTestObject = [MNFJsonAdapter objectOfClass:[MNFAdapterMainTestObject class] delegate:[[MNFAdapterSubPropertyFirstUppercaseOptionDelegate alloc] init] jsonDict:[self dictForFileName:@"JsonSubObjectFirstUppercaseTest" ofType:@"json"] option:kMNFAdapterOptionFirstLetterUppercase error:nil];
...
-(void)testSingleSubPropertyDeserializationUppercaseOptionDelegateMapping {
    ...
    MNFAdapterMainTestObject *mainTestObject = [MNFJsonAdapter objectOfClass:[MNFAdapterMainTestObject class] delegate:[[MNFAdapterSubPropertyUppercaseOptionDelegate alloc] init] jsonDict:[self dictForFileName:@"JsonSubObjectUppercaseTest" ofType:@"json"] option:kMNFAdapterOptionUppercase error:nil];
...
-(void)testSubPropertyDeserializationDelegateNoOption {
    ...
    MNFMainAdapterDelegateTestObj *delegateObj = [MNFJsonAdapter objectOfClass:[MNFMainAdapterDelegateTestObj class] jsonDict:[self dictForFileName:@"JsonSubObjectTest" ofType:@"json"] option:kMNFAdapterOptionNoOption error:nil];
...
-(void)testSubPropertyDeserializationDelegateFirstLowercaseOption {
    ...
    MNFMainAdapterDelegateFirstUppercaseTestObj *delegateObj = [MNFJsonAdapter objectOfClass:[MNFMainAdapterDelegateFirstUppercaseTestObj class] jsonDict:[self dictForFileName:@"JsonSubObjectTest" ofType:@"json"] option:kMNFAdapterOptionFirstLetterLowercase error:nil];
...
-(void)testSubPropertyDeserializationDelegateLowercaseOption {
    ...
    MNFMainAdapterDelegateUppercaseTestObj *delegateObj = [MNFJsonAdapter objectOfClass:[MNFMainAdapterDelegateUppercaseTestObj class] jsonDict:[self dictForFileName:@"JsonSubObjectLowercaseTest" ofType:@"json"] option:kMNFAdapterOptionLowercase error:nil];
...
-(void)testSubPropertyDeserializationFirstUppercaseOptionDelegateMapping {
    ...
    MNFMainAdapterDelegateTestObj *delegateObj = [MNFJsonAdapter objectOfClass:[MNFMainAdapterDelegateTestObj class] delegate:[[MNFAdapterSubPropertyMappingDelegateFirstUppercaseDelegate alloc] init] jsonDict:[self dictForFileName:@"JsonSubObjectFirstUppercaseTest" ofType:@"json"] option:kMNFAdapterOptionFirstLetterUppercase error:nil];
...
-(void)testSubPropertyDeserializationUppercaseOptionDelegateMapping {
    ...
    MNFMainAdapterDelegateTestObj *delegateObj = [MNFJsonAdapter objectOfClass:[MNFMainAdapterDelegateTestObj class] delegate:[[MNFAdapterSubPropertyMappingDelegateUppercaseDelegate alloc] init] jsonDict:[self dictForFileName:@"JsonSubObjectUppercaseTest" ofType:@"json"] option:kMNFAdapterOptionUppercase error:nil];
