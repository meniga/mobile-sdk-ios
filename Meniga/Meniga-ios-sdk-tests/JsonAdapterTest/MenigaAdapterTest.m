...
- (void)testStringFirstUppercaseOption {
    ...
    NSString *outcome = [NSStringUtils stringWithOption:kMNFAdapterOptionFirstLetterUppercase
                                             fromString:lowercaseString];
...
- (void)testStringFirstLowercaseOption {
    ...
    NSString *outcome = [NSStringUtils stringWithOption:kMNFAdapterOptionFirstLetterLowercase
                                             fromString:uppercaseString];
...
- (void)testAutomaticSingleDeserialization {
    NSString *jsonPath = [[NSBundle bundleForClass:[self class]] pathForResource:@"jsonSingleAdapterTest"
                                                                          ofType:@"json"];
    NSData *jsonData = [NSData dataWithContentsOfFile:jsonPath];

    NSDictionary *jsonDict = [NSJSONSerialization JSONObjectWithData:jsonData options:0 error:nil];

    MNFJsonAdapterTestObject *testObj = [MNFJsonAdapter objectOfClass:[MNFJsonAdapterTestObject class]
                                                             jsonDict:jsonDict
...
- (void)testAutomaticSingleDeserializationWithFirstUppercaseOption {
    NSString *jsonPath = [[NSBundle bundleForClass:[self class]] pathForResource:@"jsonAdapterSingleTestFirstUppercase"
                                                                          ofType:@"json"];
    NSData *jsonData = [NSData dataWithContentsOfFile:jsonPath];
...
- (void)testAutomaticSingleDeserialiationWithUppercaseOption {
    NSString *jsonPath = [[NSBundle bundleForClass:[self class]] pathForResource:@"jsonAdapterSingleTestUppercase"
                                                                          ofType:@"json"];
    NSData *jsonData = [NSData dataWithContentsOfFile:jsonPath];
...
- (void)testAutomaticSingleDeserializationWithFirstLowercaseOption {
    ...
    MNFJsonAdapterTestObjectPropertiesFirstUppercase *testObj =
        [MNFJsonAdapter objectOfClass:[MNFJsonAdapterTestObjectPropertiesFirstUppercase class]
                             jsonDict:jsonDict
...
- (void)testAutomaticSingleDeserializationWithLowercaseOption {
    NSString *jsonPath = [[NSBundle bundleForClass:[self class]] pathForResource:@"jsonAdapaterSingleTestLowercase"
                                                                          ofType:@"json"];
    NSData *jsonData = [NSData dataWithContentsOfFile:jsonPath];
...
- (void)testAutomaticSingleDeserializationWithDelegate {
    ...
    MNFJsonAdapterTestDelegateConformingObject *testObj =
        [MNFJsonAdapter objectOfClass:[MNFJsonAdapterTestDelegateConformingObject class]
                             jsonDict:jsonDict
                               option:kMNFAdapterOptionNoOption
                                error:nil];
...
- (void)testAutomaticSingleDeserializationWithSepcificPropertiesDelegate {
    ...
    MNFJsonAdapterTestObjectsDelegateSpecificProperties *testObject =
        [MNFJsonAdapter objectOfClass:[MNFJsonAdapterTestObjectsDelegateSpecificProperties class]
                             jsonDict:jsonDict
                               option:0
                                error:nil];
...
- (void)testAutomaticSingleDeserializationWithDelegateFirstLowercaseOption {
    ...
    MNFJsonAdapterTestObjectPropertiesFirstUppercaseDelegate *testObj =
        [MNFJsonAdapter objectOfClass:[MNFJsonAdapterTestObjectPropertiesFirstUppercaseDelegate class]
                             jsonDict:jsonDict
                               option:kMNFAdapterOptionFirstLetterLowercase
                                error:nil];
...
- (void)testAutomaticArrayDeserialization {
    NSString *jsonPath = [[NSBundle bundleForClass:[self class]] pathForResource:@"jsonArrayAdapterTest"
                                                                          ofType:@"json"];
    NSData *jsonData = [NSData dataWithContentsOfFile:jsonPath];

    NSArray *jsonArray = [NSJSONSerialization JSONObjectWithData:jsonData options:0 error:nil];

    NSArray *allDeserializedObjects = [MNFJsonAdapter objectsOfClass:[MNFJsonAdapterTestObject class]
                                                           jsonArray:jsonArray
                                                              option:kMNFAdapterOptionNoOption
                                                               error:nil];
...
- (void)testDeserializationWithCustomObjectCreation {
    ...
    MNFJsonAdapterCustomCreationTestObject *createdObj =
        [MNFJsonAdapter objectOfClass:[MNFJsonAdapterCustomCreationTestObject class]
                             jsonDict:jsonDict
                               option:0
                                error:nil];
    ...
    XCTAssertEqualObjects(createdObj.title,
                          @"sunt aut facere repellat provident occaecati excepturi optio reprehenderit");
    XCTAssertEqualObjects(createdObj.body,
...
- (void)testDeserializationWithArrayOfCustomObjectCreation {
    ...
    NSArray *allDeserializedObjects = [MNFJsonAdapter objectsOfClass:[MNFJsonAdapterCustomCreationTestObject class]
                                                           jsonArray:jsonArray
                                                              option:0
                                                               error:nil];
...
- (void)testAutomaticDeserializationDateStringTransformer {
    NSString *jsonPath = [[NSBundle bundleForClass:[self class]] pathForResource:@"jsonAdapterTestValueTransformer"
                                                                          ofType:@"json"];
    ...
    MNFJsonAdapterTestValueTransformerDelegate *testObj =
        [MNFJsonAdapter objectOfClass:[MNFJsonAdapterTestValueTransformerDelegate class]
                             jsonDict:jsonDict
                               option:0
                                error:nil];
...
- (void)testAutomaticDeserializationDateStringFirstUppercaseValueTransformer {
    NSString *jsonPath =
        [[NSBundle bundleForClass:[self class]] pathForResource:@"jsonAdapterTestFirstUppercaseValueTransformer"
                                                         ofType:@"json"];
...
- (void)testAutomaticDeserializationDateStringUppercaseValueTransformer {
    NSString *jsonPath =
        [[NSBundle bundleForClass:[self class]] pathForResource:@"jsonAdapterTestUppercaseValueTransformer"
                                                         ofType:@"json"];
...
- (void)testAutomaticDeserializationDateStringLowercaseValueTransformer {
    ...
    MNFJsonAdapterTestUppercaseValueTransformerDelegate *testObj =
        [MNFJsonAdapter objectOfClass:[MNFJsonAdapterTestUppercaseValueTransformerDelegate class]
                             jsonDict:jsonDict
                               option:kMNFAdapterOptionLowercase
                                error:nil];
...
- (void)testAutomaticDeserializationDateStringFirstLowercaseValueTransformer {
    ...
    MNFJsonAdapterTestFirstUppercaseValueTransformerDelegate *testObj =
        [MNFJsonAdapter objectOfClass:[MNFJsonAdapterTestFirstUppercaseValueTransformerDelegate class]
                             jsonDict:jsonDict
                               option:kMNFAdapterOptionFirstLetterLowercase
                                error:nil];
...
- (void)testAutomaticDeserializationWithCustomDelegateObjectNoOption {
    ...
    MNFJsonAdapterTestObject *testObj =
        [MNFJsonAdapter objectOfClass:[MNFJsonAdapterTestObject class]
                             delegate:[[MNFSeparateNormalOptionDelegateObject alloc] init]
                             jsonDict:jsonDict
                               option:kMNFAdapterOptionNoOption
                                error:nil];
    ...
    XCTAssertEqualObjects(testObj.body,
                          @"quia et suscipit\nsuscipit recusandae consequuntur expedita et cum\nreprehenderit "
                          @"molestiae ut ut quas totam\nnostrum rerum est autem sunt rem eveniet architecto");
...
- (void)testAutomaticDeserializationWithCustomDelegateObjectFirstLowercaseOption {
    ...
    MNFJsonAdapterTestObjectPropertiesFirstUppercase *testObj =
        [MNFJsonAdapter objectOfClass:[MNFJsonAdapterTestObjectPropertiesFirstUppercase class]
                             delegate:[[MNFSeparateFirstUppercaseOptionDelegateObject alloc] init]
                             jsonDict:jsonDict
                               option:kMNFAdapterOptionFirstLetterLowercase
                                error:nil];
...
- (void)testAutomaticDeserializationObjectUpdateFirstLetterUppercaseOption {
    ...
    [MNFJsonAdapter refreshObject:testObj
                     withJsonDict:[mutJsonDict copy]
                           option:kMNFAdapterOptionFirstLetterUppercase
                            error:nil];
...
- (void)testAutomaticDeserializationObjectUpdateSeparateDelegate {
    ...
    [MNFJsonAdapter refreshObject:testObj
                         delegate:[[MNFSeparateNormalOptionUpdateDelegateObject alloc] init]
                         jsonDict:[mutJsonDict copy]
                           option:kMNFAdapterOptionNoOption
                            error:nil];
...
- (void)testAutomaticDeserializationObjectUpdateFirstLetterLowercaseOptionSeparateDelegate {
    ...
    [MNFJsonAdapter refreshObject:testObj
                         delegate:[[MNFSeparateFirstUppercaseOptionUpdateDelegateObject alloc] init]
                         jsonDict:[mutJsonDict copy]
                           option:kMNFAdapterOptionFirstLetterLowercase
                            error:nil];
...
- (void)testAutomaticSerialization {
    MNFJsonAdapterTestObject *testObj = [MNFJsonAdapterTestObject initWithUserId:[NSNumber numberWithInt:10]
                                                                          postId:nil
                                                                            body:nil
                                                                           title:@"Title"];

    NSDictionary *serializedDict = [MNFJsonAdapter JSONDictFromObject:testObj
                                                               option:kMNFAdapterOptionNoOption
                                                                error:nil];
...
- (void)testAutomaticSerializationWithFirstLowercaseOption {
    MNFJsonAdapterTestObjectPropertiesFirstUppercase *testObj =
        [MNFJsonAdapterTestObjectPropertiesFirstUppercase initWithUserId:[NSNumber numberWithInt:7]
                                                                  postId:[NSNumber numberWithInt:19]
                                                                    body:@"Test body"
                                                                   title:@"Test title"];
...
- (void)testAutomaticSerializationWithUppercaseOption {
    MNFJsonAdapterTestObject *testObj = [MNFJsonAdapterTestObject initWithUserId:[NSNumber numberWithInt:8]
                                                                          postId:[NSNumber numberWithInt:3]
                                                                            body:nil
                                                                           title:@"Test title"];
...
- (void)testAutomaticSerializationWithLowercaseOption {
    MNFJsonAdapterTestObject *testObj = [MNFJsonAdapterTestObject initWithUserId:nil
                                                                          postId:[NSNumber numberWithInt:7]
                                                                            body:@"Test body"
                                                                           title:nil];
...
- (void)testAutomaticSerializationWithDelegate {
    MNFJsonAdapterTestDelegateConformingObject *testObj =
        [MNFJsonAdapterTestDelegateConformingObject initWithUserId:[NSNumber numberWithInt:10]
                                                            postId:[NSNumber numberWithInt:9]
                                                              body:@"Body"
                                                             title:@"Title"];
...
- (void)testAutomaticSerializationWithSpecificPropertiesDelegate {
    MNFJsonAdapterTestObjectsDelegateSpecificProperties *testObj =
        [MNFJsonAdapterTestObjectsDelegateSpecificProperties initWithUserId:nil
                                                                     postId:[NSNumber numberWithInt:6]
                                                                       body:@"Test body"
                                                                      title:nil];
...
- (void)testAutomaticSerilaizationWithDelegateFirstLetterLowercaseOption {
    MNFJsonAdapterTestObjectPropertiesFirstUppercaseDelegate *testObj =
        [MNFJsonAdapterTestObjectPropertiesFirstUppercaseDelegate initWithUserId:[NSNumber numberWithInt:11]
                                                                          postId:[NSNumber numberWithInt:93]
                                                                            body:@"Test body"
                                                                           title:@"Test title"];
...
- (void)testSerializationWithSeparateDelegateNoOption {
    ...
    NSDictionary *serializedDict =
        [MNFJsonAdapter JSONDictFromObject:testObj
                                  delegate:[[MNFSeparateNormalOptionDelegateObject alloc] init]
                                    option:kMNFAdapterOptionNoOption
                                     error:nil];
...
- (void)testAutomaticSerializationWithTransformer {
    MNFJsonAdapterTestValueTransformerDelegate *testObj =
        [[MNFJsonAdapterTestValueTransformerDelegate alloc] initWithName:@"name" birthday:[NSDate date]];
...
- (void)testAutomaticSerializationFirstUppercaseWithTransformer {
    MNFJsonAdapterTestValueTransformerDelegate *testObj =
        [[MNFJsonAdapterTestValueTransformerDelegate alloc] initWithName:@"The Name" birthday:[NSDate date]];

    NSDictionary *serializeDict = [MNFJsonAdapter JSONDictFromObject:testObj
                                                              option:kMNFAdapterOptionFirstLetterUppercase
                                                               error:nil];
...
- (void)testAutomaticSerializationFirstLowercaseWithTransformer {
    MNFJsonAdapterTestFirstUppercaseValueTransformerDelegate *testObj =
        [[MNFJsonAdapterTestFirstUppercaseValueTransformerDelegate alloc] initWithName:@"The Name"
...
- (void)testAutomaticSerializationLowercaseWithTransformer {
    MNFJsonAdapterTestUppercaseValueTransformerDelegate *testObj =
        [[MNFJsonAdapterTestUppercaseValueTransformerDelegate alloc] initWithName:@"The Name" birthday:[NSDate date]];
...
- (void)testRestrictedPropertyErrorDeserialization {
    ...
    MNFJsonAdapterRestrictedPRopertyErrorTestObject *testObj =
        [MNFJsonAdapter objectOfClass:[MNFJsonAdapterRestrictedPRopertyErrorTestObject class]
                             jsonDict:jsonDict
                               option:kMNFAdapterOptionNoOption
                                error:&error];
...
- (void)testIgnoredPropertyErrorDeserialization {
    ...
    MNFJsonAdapterIgnoreErrorTestObject *testObj =
        [MNFJsonAdapter objectOfClass:[MNFJsonAdapterIgnoreErrorTestObject class]
                             jsonDict:jsonDict
                               option:kMNFAdapterOptionNoOption
                                error:&error];
...
- (void)testJsonKeyMapToPropertyErrorDeserialization {
    ...
    MNFJsonAdapterJsonKeyMapToPropertyErrorTestObject *testObj =
        [MNFJsonAdapter objectOfClass:[MNFJsonAdapterJsonKeyMapToPropertyErrorTestObject class]
                             jsonDict:jsonDict
                               option:kMNFAdapterOptionNoOption
                                error:&error];
...
- (void)testRestrictedPropertyKeyErrorSerialization {
    MNFJsonAdapterRestrictedPRopertyErrorTestObject *testObj =
        [[MNFJsonAdapterRestrictedPRopertyErrorTestObject alloc] init];
...
- (void)testPropertyKeyMapToJsonErrorSerialization {
    MNFJsonAdapterPropertyKeyMapToJsonErrorTestObject *testObj =
        [MNFJsonAdapterPropertyKeyMapToJsonErrorTestObject initWithUserId:[NSNumber numberWithInt:1]
                                                                   postId:[NSNumber numberWithInt:10]
                                                                     body:@"Some body"
                                                                    title:@"Some title"];
...
- (void)testIgnoredPropertyErrorSerialization {
    MNFJsonAdapterIgnoreErrorTestObject *testObj =
        [MNFJsonAdapterIgnoreErrorTestObject initWithUserId:[NSNumber numberWithInt:1]
                                                     postId:[NSNumber numberWithInt:2]
                                                       body:@"Some body"
                                                      title:@"Some title"];
