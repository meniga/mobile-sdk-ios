...
+ (id)objectOfClass:(Class)theClass
    ...
    MNFLogVerbose(
        @"Deserialize object with type: %@ option: %ld, json dictionary: %@", theClass, theAdapterOption, theJsonDict);
    ...
    return [self objectOfClass:theClass
                      delegate:theDelegate
                      jsonDict:theJsonDict
                        option:theAdapterOption
                         error:theError];
}
...
+ (NSArray *)objectsOfClass:(Class)theClass
    ...
    MNFLogVerbose(@"Deserialize NSArry of objects with type: %@ option: %ld, json dictionary: %@",
                  theClass,
                  theAdapterOption,
                  theJsonArray);
    ...
    return [self objectsOfClass:theClass
                       delegate:theDelegate
...
+ (id)objectOfClass:(Class)theClass
    ...
    return [tmpSerializer p_createInstanceFromClass:theClass
                                           delegate:theDelegate
                                           jsonDict:theJsonDict
                                       propertyKeys:[tmpSerializer p_propertyKeysForClass:theClass
                                                                                 delegate:theDelegate
                                                                                   option:theAdapterOption
                                                                                    error:theError]
                                             option:theAdapterOption];
...
+ (NSArray *)objectsOfClass:(Class)theClass
    ...
    return [tmpSerializer p_createInstancesForClass:theClass
                                           delegate:theDelegate
                                          jsonArray:theJsonArray
                                       propertyKeys:[tmpSerializer p_propertyKeysForClass:theClass
                                                                                 delegate:theDelegate
...
+ (BOOL)refreshObject:(NSObject<MNFJsonAdapterDelegate> *)theModel
    ...
    return [tmpSerializer p_refreshInstance:theModel
                                   delegate:theModel
                                   jsonDict:theJsonDict
                               propertyKeys:[tmpSerializer p_propertyKeysForClass:[theModel class]
                                                                         delegate:theModel
                                                                           option:theAdapterOption
                                                                            error:theError]
                                     option:theAdapterOption
...
- (NSDictionary *)p_propertyKeysForClass:(Class)theClass
                                delegate:(id<MNFJsonAdapterDelegate>)theDelegate
    ...
    if ([theDelegate respondsToSelector:@selector(propertiesToDeserialize)]) {
        ...
        if ([theDelegate propertiesToIgnoreJsonDeserialization] != nil) {
            propertyKeys =
                [self p_removeIgnoredPropertiesInDictionary:propertyKeys
                                          ignoredProperties:[theDelegate propertiesToIgnoreJsonDeserialization]
                                                      error:theError];
        }
    }
    ...
    if ([theDelegate respondsToSelector:@selector(jsonKeysMapToProperties)]) {
        if ([theDelegate jsonKeysMapToProperties] != nil) {
            propertyKeys = [self p_mapPropertyDictionaryKeys:propertyKeys
                                               mapDictionary:[theDelegate jsonKeysMapToProperties]
                                                       error:theError];
        }
    }
...
- (NSArray *)p_createInstancesForClass:(Class)theClass
                              delegate:(id<MNFJsonAdapterDelegate>)theDelegate
                             jsonArray:(NSArray *)theJsonArray
                          propertyKeys:(NSDictionary *)thePropertyKeys
                                option:(MNFAdapterOption)theOption {
    NSMutableArray *arr = [NSMutableArray array];

    for (NSDictionary *dict in theJsonArray) {
        [arr addObject:[self p_createInstanceFromClass:theClass
                                              delegate:theDelegate
                                              jsonDict:dict
                                          propertyKeys:thePropertyKeys
                                                option:theOption]];
    }
...
- (id)p_createInstanceFromClass:(Class<MNFJsonAdapterDelegate>)theClass
                       delegate:(id<MNFJsonAdapterDelegate>)theDelegate
                       jsonDict:(NSDictionary *)theJsonDict
                   propertyKeys:(NSDictionary *)thePropertyKeys
                         option:(MNFAdapterOption)theOption {
    NSArray *array = [[self class] p_createModelDictionaryWithDelegate:theDelegate
                                                              jsonDict:theJsonDict
                                                          propertyKeys:thePropertyKeys
                                                                option:theOption];
...
- (BOOL)p_refreshInstance:(NSObject<MNFJsonAdapterDelegate> *)theModel
                 delegate:(id<MNFJsonAdapterDelegate>)theDelegate
                 jsonDict:(NSDictionary *)theJsonDict
             propertyKeys:(NSDictionary *)thePropertyKeys
                   option:(MNFAdapterOption)theOption
                    error:(NSError **)theError {
    NSArray<MNFJsonAdapterKeyAndProperty *> *array = [[self class] p_createModelDictionaryWithDelegate:theModel
                                                                                              jsonDict:theJsonDict
                                                                                          propertyKeys:thePropertyKeys
                                                                                                option:theOption];
    BOOL aggregatedSuccess = YES;
    for (MNFJsonAdapterKeyAndProperty *currentAdapterObj in array) {
        BOOL localSuccess = [NSObjectRuntimeUtils validateAndSetValue:currentAdapterObj.propertyValue
                                                          propertyKey:currentAdapterObj.propertyKey
                                                              onModel:theModel
                                                                error:theError];
        if (localSuccess == NO) {
...
+ (NSArray *)p_createModelDictionaryWithDelegate:(id<MNFJsonAdapterDelegate>)theDelegate
                                        jsonDict:(NSDictionary *)theJsonDict
                                    propertyKeys:(NSDictionary *)thePropertyKeys
                                          option:(MNFAdapterOption)theOption {
    ...
    for (NSString *jsonKey in theJsonDict) {
        ...
        if (propertyName != nil) {
            if (transformedDict != nil && [transformedDict objectForKey:propertyName] != nil &&
                [[transformedDict objectForKey:propertyName] isKindOfClass:[NSValueTransformer class]] == YES
            ...
            if (subPropertyDict != nil && [subPropertyDict objectForKey:propertyName] != nil) {
                ...
                jsonValue = [self createSubObjectWithClass:subclassProperty.propertyClass
                                                  delegate:subclassProperty.propertyDelegate
                                                    option:subclassProperty.propertyOption
                                                  jsonDict:jsonValue];
            }
...
+ (id)createSubObjectWithClass:(Class)theClass
                      delegate:(id<MNFJsonAdapterDelegate>)theDelegate
                        option:(MNFAdapterOption)theOption
                      jsonDict:(NSDictionary *)theJsonDict {
    MNFJsonAdapterValueTransformer *valueTrans = [MNFJsonAdapterValueTransformer transformerWithClass:theClass
                                                                                             delegate:theDelegate
                                                                                               option:theOption];
...
+ (NSArray *)JSONArrayFromArray:(NSArray *)theModels
    ...
    if (theModels.count == 0) {
        ...
        if (theError != nil) {
            *theError = [NSError errorWithDomain:@"JsonAdapterDomain"
                                            code:5765
                                        userInfo:@{ NSLocalizedDescriptionKey: @"Cannot serialize an empty array" }];
        }
...
+ (NSArray *)JSONArrayFromArray:(NSArray *)theModels
    ...
    NSDictionary *propertyKeys = [automaticSerializer p_createPropertyKeyDictionaryForObject:[theModels firstObject]
                                                                                    delegate:theDelegate
                                                                                      option:theAdapterOption
                                                                                       error:theError];
    ...
    for (id object in theModels) {
        NSDictionary *jsonDict = [automaticSerializer p_createPeropertyValueDictionaryForObject:object
                                                                                       delegate:theDelegate
                                                                             propertyDictionary:propertyKeys
                                                                                         option:theAdapterOption];
...
+ (NSDictionary *)JSONDictFromObject:(id)theModel
    ...
    return [automaticSerializer p_createJSONDictFromObject:theModel
                                                  delegate:theDelegate
                                                    option:theAdapterOption
                                                     error:theError];
}
...
+ (NSData *)JSONDataFromObject:(id)theModel
    ...
    return [automaticSerializer p_createJSONDataFromObject:theModel
                                                  delegate:theDelegate
                                                    option:theAdapterOption
                                                     error:theError];
}
...
- (NSData *)p_createJSONDataFromObject:(id)theModel
                              delegate:(id<MNFJsonAdapterDelegate>)theDelegate
                                option:(MNFAdapterOption)theAdapterOption
                                 error:(NSError **)theError {
    NSDictionary *theDict = [self p_createJSONDictFromObject:theModel
                                                    delegate:theDelegate
                                                      option:theAdapterOption
                                                       error:theError];
...
- (NSDictionary *)p_createJSONDictFromObject:(id)theModel
                                    delegate:(id<MNFJsonAdapterDelegate>)theDelegate
                                      option:(MNFAdapterOption)theAdapterOption
                                       error:(NSError **)theError {
    NSDictionary *propertyKeys = [self p_createPropertyKeyDictionaryForObject:theModel
                                                                     delegate:theDelegate
                                                                       option:theAdapterOption
                                                                        error:theError];

    // now get the values of the properties and store them in an NSDictionary
    NSDictionary *newJsonDict = [self p_createPeropertyValueDictionaryForObject:theModel
                                                                       delegate:theDelegate
                                                             propertyDictionary:propertyKeys
                                                                         option:theAdapterOption];
...
- (NSDictionary *)p_createPropertyKeyDictionaryForObject:(id<MNFJsonAdapterDelegate>)theModel
                                                delegate:(id<MNFJsonAdapterDelegate>)theDelegate
                                                  option:(MNFAdapterOption)theAdapterOption
                                                   error:(NSError **)theError {
    ...
    if ([theDelegate respondsToSelector:@selector(propertiesToSerialize)]) {
        ...
        if ([theDelegate propertiesToIgnoreJsonSerialization] != nil) {
            propertyKeys = [self p_removeIgnoredPropertiesInDictionary:propertyKeys
                                                     ignoredProperties:[theDelegate propertiesToIgnoreJsonSerialization]
                                                                 error:theError];
        }
    }
    ...
    if ([theDelegate respondsToSelector:@selector(propertyKeysMapToJson)]) {
        if ([theDelegate propertyKeysMapToJson] != nil) {
            propertyKeys = [self p_mapPropertyKeyValues:propertyKeys
                                          mapDictionary:[theDelegate propertyKeysMapToJson]
                                                  error:theError];
        }
    }
...
- (NSDictionary *)p_createPeropertyValueDictionaryForObject:(NSObject *)theModelObject
                                                   delegate:(id<MNFJsonAdapterDelegate>)theDelegate
                                         propertyDictionary:(NSDictionary *)thePropertyDictionary
                                                     option:(MNFAdapterOption)theOption {
    ...
    for (NSString *currentProperty in thePropertyDictionary) {
        ...
        if (transformerDict != nil && value != nil && [transformerDict valueForKey:currentProperty] != nil &&
            [[transformerDict valueForKey:currentProperty] isKindOfClass:[NSValueTransformer class]] == YES) {
            NSValueTransformer *transformer = [transformerDict valueForKey:currentProperty];
            value = [transformer reverseTransformedValue:value];
        }

        if (subPropertyDict != nil && [subPropertyDict objectForKey:currentProperty] != nil &&
            [[subPropertyDict objectForKey:currentProperty] isKindOfClass:[MNFJsonAdapterSubclassedProperty class]]
                == YES) {
            MNFJsonAdapterSubclassedProperty *subclassProperty = [subPropertyDict objectForKey:currentProperty];

            value = [self createSubObjectWithClass:subclassProperty.propertyClass
                                          delegate:subclassProperty.propertyDelegate
                                            option:subclassProperty.propertyOption
                                            object:value];
        }
...
- (nullable id)createSubObjectWithClass:(Class)theClass
                               delegate:(id<MNFJsonAdapterDelegate>)theDelegate
                                 option:(MNFAdapterOption)theOption
                                 object:(id)theObject {
    MNFJsonAdapterValueTransformer *valueTransformer = [MNFJsonAdapterValueTransformer transformerWithClass:theClass
                                                                                                   delegate:theDelegate
                                                                                                     option:theOption];
...
- (NSDictionary *)p_propertyKeyDictionaryAssociatedWithClass:(Class)theClass error:(NSError **)theError {
    ...
    [NSObjectRuntimeUtils enumeratePropertiesOnClass:theClass
                                          UsingBlock:^(objc_property_t property, BOOL *stop) {
...
- (NSDictionary *)p_removeNSObjectPropertiesFromDict:(NSMutableDictionary *)theDict {
    [NSObjectRuntimeUtils enumeratePropertiesOnClass:[NSObject class]
                                          UsingBlock:^(objc_property_t property, BOOL *stop) {
...
- (NSDictionary *)p_mapPropertyDictionaryKeys:(NSDictionary *)thePropertyDictToMap
                                mapDictionary:(NSDictionary *)theMapDictionary
                                        error:(NSError **)theError {
        ...
        if (foundPropertyToMap == NO && theError != nil) {
            *theError = [NSError
                errorWithDomain:JsonAdapterDomain
                           code:kMenigaJsonErrorMapPropertyKeyNotFound
                       userInfo:@{
                           NSLocalizedDescriptionKey: [NSString
                               stringWithFormat:@"%@ %@ %@",
                                                NSLocalizedString(
                                                    @"<MenigaJsonAdapterMapPropertyNotFoundKeyErrorPartOne>", @""),
                                                mapPropertyKey,
                                                NSLocalizedString(
                                                    @"<MenigaJsonAdapterMapPropertyNotFoundKeyErrorPartTwo>", @"")]
                       }];
...
- (NSDictionary *)p_mapPropertyKeyValues:(NSDictionary *)thePropertyDict
                           mapDictionary:(NSDictionary *)theMapDictionary
                                   error:(NSError **)theError {
...
- (NSDictionary *)p_removeIgnoredPropertiesInDictionary:(NSDictionary *)thePropertyDict
                                      ignoredProperties:(NSSet *)thePropertiesToIgnore
                                                  error:(NSError **)theError {
    ...
    for (NSString *ignoredPropertyKey in thePropertiesToIgnore) {
        ...
        if (foundIgnoredPropertyKey == NO && theError != nil) {
            ...
            *theError =
                [NSError errorWithDomain:JsonAdapterDomain
                                    code:kMenigaJsonErrorIgnoredPropertyKeyNotFound
                                userInfo:@{
                                    NSLocalizedDescriptionKey: [NSString
                                        stringWithFormat:@"%@: %@",
                                                         NSLocalizedString(
                                                             @"<MenigaJsonAdapterIgnoredPropertyKeyNotFoundErro>", @""),
                                                         ignoredPropertyKey]
                                }];
        }
    }
...
- (NSDictionary *)p_updateDictionaryKeysAndValues:(NSDictionary *)theDict option:(MNFAdapterOption)theAdapterOption {
    ...
    for (NSString *key in theDict) {
        ...
        [newDict setObject:[NSStringUtils stringWithOption:theAdapterOption fromString:dictValue]
                    forKey:[NSStringUtils stringWithOption:theAdapterOption fromString:key]];
    }
