...
+(instancetype)transformerWithClass:(Class)theClass delegate:(id<MNFJsonAdapterDelegate>)theDelegate option:(MNFAdapterOption)theOption {
    ...
    MNFJsonAdapterValueTransformer *valueTransformer = [[MNFJsonAdapterValueTransformer alloc] initWithClass:theClass delegate: theDelegate option: theOption];
...
-(id)transformedValue:(id)value error:(NSError **)theError {
    ...
    if ([value isKindOfClass:[NSArray class]] == YES) {
        ...
        NSArray *objects = [MNFJsonAdapter objectsOfClass:_class delegate:_delegate jsonArray:array option:_option error:theError];
        ...
        id object = [MNFJsonAdapter objectOfClass:_class delegate:_delegate jsonDict:dict option:_option error:theError];
