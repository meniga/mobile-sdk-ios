...
+(instancetype)subclassedPropertyWithClass:(Class)theClass option:(MNFAdapterOption)theOption {
    ...
    MNFJsonAdapterSubclassedProperty *subProperty = [[[self class] alloc] initWithClass: theClass delegate:[[theClass alloc] init] option:theOption];
...
+(instancetype)subclassedPropertyWitoutDelegate:(Class)theClass option:(MNFAdapterOption)theOption {
    ...
    MNFJsonAdapterSubclassedProperty *subProperty = [[[self class] alloc] initWithClass:theClass delegate:nil option:theOption];
