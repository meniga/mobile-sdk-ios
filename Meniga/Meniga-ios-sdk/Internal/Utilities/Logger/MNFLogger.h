...
#define kObjectBlockDataDebugLog MNFLogDebug(@"[%@ %@] with result: %@", [self class], NSStringFromSelector(_cmd), response.result)
//Outputting a debug log with the returned data from a task based request.
#define kObjectTaskDataDebugLog MNFLogDebug(@"[%@ %@] with result: %@", [self class], NSStringFromSelector(_cmd), result)

//Outputting an error log when unexpected class is returned from a block based request. Takes in the expected class.
#define kObjectBlockDataErrorLogWithExpectedClass(v) MNFLogError([NSString stringWithFormat:@"Unexpected response data format. Expected: %@ Got: %@", NSStringFromClass(v), NSStringFromClass([response.result class])])
//Outputting an error log when unexpected class is returned from a task based request. Takes in the expected class.
#define kObjectTaskDataErrorLogWithExpectedClass(v) MNFLogError([NSString stringWithFormat:@"Unexpected response data format. Expected: %@ Got: %@", NSStringFromClass(v), NSStringFromClass([task.result class])])
//Outputting a debug log when unexpected class is returned from a block based request. Takes in the expected class.
#define kObjectBlockDataDebugLogWithExpectedClass(v) MNFLogDebug([NSString stringWithFormat:@"Unexpected response data format. Expected: %@ Got: %@", NSStringFromClass(v), NSStringFromClass([response.result class])])
//Outputting an debug log when unexpected class is returned from a task based request. Takes in the expected class.
#define kObjectTaskDataDebugLogWithExpectedClass(v) MNFLogDebug([NSString stringWithFormat:@"Unexpected response data format. Expected: %@ Got: %@", NSStringFromClass(v), NSStringFromClass([task.result class])])
