...
+ (MNFJob *)fetchBudgetsWithIds:(NSString *)ids
    ...
    __block MNFJob *job = [MNFObject
        apiRequestWithPath:kMNFApiPathBudget
                 pathQuery:[jsonDict copy]
                  jsonBody:nil
                HTTPMethod:kMNFHTTPMethodGET
                   service:MNFServiceNameBudget
...
- (MNFJob *)fetchBudgetEntriesWithFilter:(MNFBudgetFilter *)filter
                              completion:(MNFMultipleBudgetEntriesCompletionHandler)completion {
    [completion copy];
...
- (NSDictionary *)jsonKeysMapToProperties {
    return @{ @"identifier": @"id", @"budgetDescription": @"description" };
}
...
- (NSDictionary *)subclassedProperties {
    return @{
        @"entries": [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFBudgetEntry class]
                                                                           option:kMNFAdapterOptionNoOption]
    };
}
