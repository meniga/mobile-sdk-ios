...
+ (MNFJob *)fetchRulesWithBudgetId:(NSNumber *)budgetId
             ...
             allowOverlappingRules:(NSNumber *)allowOverlappingRules
                        completion:(MNFMultipleBudgetRulesCompletionHandler)completion {
    [completion copy];
...
- (NSDictionary *)subclassedProperties {
    return @{
        @"recurringPattern":
            [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFBudgetRuleRecurringPattern class]
