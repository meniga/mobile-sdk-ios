...
+ (MNFJob *)fetchPeerComparisonWithCategoryIds:(NSString *)categoryIds
                                   excludeUser:(NSNumber *)excludeUser
                                previousMonths:(NSNumber *)previousMonths
                               groupCategories:(NSNumber *)groupCategories
                                     segmentBy:(NSNumber *)segmentBy
                                    completion:(MNFPeerComparisonCompletionHandler)completion {
    [completion copy];
    ...
    __block MNFJob *job = [self
        apiRequestWithPath:kMNFApiPathPeerComparison
...
+ (MNFJob *)fetchTopMerchantsWithLimit:(NSNumber *)limit
                                rankBy:(NSNumber *)rankBy
                           excludeUser:(NSNumber *)excludeUser
    ...
    __block MNFJob *job = [self
        apiRequestWithPath:kMNFPeerComparisonTopMerchants
                 pathQuery:[jsonQuery copy]
                  jsonBody:nil
                HTTPMethod:kMNFHTTPMethodGET
                   service:MNFServiceNamePeerComparison
...
- (NSDictionary *)subclassedProperties {
    return @{
        @"user": [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFPeerComparisonStats class]
                                                                        option:kMNFAdapterOptionNoOption],
        @"community": [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFPeerComparisonStats class]
                                                                             option:kMNFAdapterOptionNoOption],
        @"userMerchants":
            [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFPeerComparisonMerchants class]
                                                                   option:kMNFAdapterOptionNoOption],
        @"communityMerchants":
            [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFPeerComparisonMerchants class]
                                                                   option:kMNFAdapterOptionNoOption]
