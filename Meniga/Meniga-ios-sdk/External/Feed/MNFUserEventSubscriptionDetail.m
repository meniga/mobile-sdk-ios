...
+ (MNFJob *)fetchSubscriptionDetailsWithCompletion:(MNFUserEventSubscriptionDetailCompletionHandler)completion {
    ...
    __block MNFJob *job = [self apiRequestWithPath:kMNFUserEventsSubscriptionDetails pathQuery:nil jsonBody:nil HTTPMethod:kMNFHTTPMethodGET service:MNFServiceNameUserEvents completion:^(MNFResponse * _Nullable response) {
        ...
        if (response.error == nil) {
            ...
            if ([response.result isKindOfClass:[NSArray class]]) {
                ...
                [MNFObject executeOnMainThreadWithJob:job completion:completion parameter:subscriptionDetails error:nil];
...
-(NSDictionary <NSString *, MNFJsonAdapterSubclassedProperty *> *)subclassedProperties {
    return @{
             @"subscriptions": [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass: [MNFUserEventSubscription class] option: kMNFAdapterOptionNoOption],
             @"settings": [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass: [MNFUserEventSubscriptionSetting class] option: kMNFAdapterOptionNoOption],
             @"children": [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass: [MNFUserEventSubscriptionDetail class] option: kMNFAdapterOptionNoOption]
             };
}
