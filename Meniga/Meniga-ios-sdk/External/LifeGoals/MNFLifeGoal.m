    ...
    __block MNFJob *job = [self
        apiRequestWithPath:path
                ...
                HTTPMethod:kMNFHTTPMethodGET
                   service:MNFServiceNameLifeGoals
...
+ (MNFJob *)fetchLifeGoalsWithCompletion:(MNFMultipleLifeGoalsCompletionHandler)completion {
    ...
    __block MNFJob *job = [self
        apiRequestWithPath:kMNFApiPathLifeGoals
                 pathQuery:nil
                  jsonBody:nil
                HTTPMethod:kMNFHTTPMethodGET
                   service:MNFServiceNameLifeGoals
...
+ (MNFJob *)fetchLifeGoalsAccountInfoWithAccountIds:(NSString *)accountIds
                                         completion:(MNFLifeGoalAccountInfoCompletionHandler)completion {
    [completion copy];
    ...
    __block MNFJob *job = [self
        apiRequestWithPath:kMNFLifeGoalsAccountInfo
...
+ (MNFJob *)lifeGoalWithName:(NSString *)name
                   accountId:(NSNumber *)accountId
                targetAmount:(NSNumber *)targetAmount
             recurringAmount:(NSNumber *)recurringAmount
               initialAmount:(NSNumber *)initialAmount
                  targetDate:(NSDate *)targetDate
                  categoryId:(NSNumber *)categoryId
                    metadata:(NSString *)metadata
      recurrenceIntervalType:(NSString *)recurrenceIntervalType
                  completion:(MNFLifeGoalCompletionHandler)completion {
    [completion copy];
...
- (NSDictionary *)propertyValueTransformers {
    return @{
        @"expectedTargetDate": [MNFBasicDateValueTransformer transformer],
