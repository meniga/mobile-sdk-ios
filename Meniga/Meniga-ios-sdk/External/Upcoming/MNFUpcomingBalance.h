 ...
 */
+(MNFJob*)fetchBalancesWithDateTo:(NSDate*)dateTo includeOverdueFromDate:(nullable NSDate*)overdueFromDate accountIds:(nullable NSString*)accountIds includeUnlinked:(BOOL)includeUnlinked useAvailableAmount:(BOOL)useAvailableAmount completion:(nullable MNFBalancesCompletionHandler)completion;
