                ...
                completion:^(MNFResponse *_Nullable response) {
                    ...
                    if (response.error == nil) {
                        if ([response.result isKindOfClass:[NSDictionary class]]) {
                            MNFUpcomingThreshold *threshold =
                                [MNFUpcomingThreshold initWithServerResult:response.result];
...
+ (MNFJob *)fetchThresholdsWithAccountIds:(NSString *)accountIds
                               completion:(MNFMultipleThresholdsCompletionHandler)completion {
    [completion copy];
    ...
    __block MNFJob *job = [MNFObject
        apiRequestWithPath:kMNFUpcomingThresholds
...
+ (MNFJob *)createThresholdWithValue:(NSNumber *)value
                        isUpperLimit:(NSNumber *)isUpperLimit
                          accountIds:(NSString *)accountIds
                          completion:(MNFThresholdCompletionHandler)completion {
    [completion copy];
