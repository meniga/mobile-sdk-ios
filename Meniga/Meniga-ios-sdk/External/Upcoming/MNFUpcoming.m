...
+ (MNFJob *)fetchUpcomingFromDate:(NSDate *)fromDate
                       ...
                       completion:(MNFMultipleUpcomingCompletionHandler)completion {
    [completion copy];

    return [self fetchUpcomingFromDate:fromDate
                                toDate:toDate
                            accountIds:nil
                        includeDetails:YES
                           watchedOnly:NO
                    recurringPatternId:nil
                         paymentStatus:MNFUpcomingPaymentStatusNone
                            completion:completion];
}
...
+ (MNFJob *)fetchUpcomingFromDate:(NSDate *)fromDate
               ...
               recurringPatternId:(NSNumber *)recurringPatternId
    ...
    __block MNFJob *job = [MNFObject
        apiRequestWithPath:kMNFApiPathUpcoming
...
+ (MNFJob *)createUpcomingWithText:(NSString *)text
                  amountInCurrency:(NSNumber *)amountInCurrency
                      currencyCode:(NSString *)currencyCode
                        ...
                        categoryId:(NSNumber *)categoryId
                         ...
                         isWatched:(NSNumber *)isWatched
                  recurringPattern:(MNFUpcomingRecurringPattern *)recurringPattern
                        completion:(MNFMultipleUpcomingCompletionHandler)completion {
    [completion copy];
    ...
    if (recurringPattern != nil) {
        NSDictionary *dictionary = [MNFJsonAdapter JSONDictFromObject:recurringPattern
...
- (MNFJob *)postComment:(NSString *)comment withCompletion:(MNFErrorOnlyCompletionHandler)completion {
    ...
    NSString *path =
        [NSString stringWithFormat:@"%@/%@/%@", kMNFApiPathUpcoming, [self.identifier stringValue], @"comments"];
...
+ (MNFJob *)fetchDefaultAccountIdWithCompletion:(MNFDefaultAccountIdCompletionHandler)completion {
    ...
    __block MNFJob *job = [MNFObject
        apiRequestWithPath:kMNFUpcomingAccountsDefault
                 pathQuery:nil
                  jsonBody:nil
                HTTPMethod:kMNFHTTPMethodGET
                   service:MNFServiceNameUpcoming
...
+ (MNFJob *)fetchIncludedAccountIdsWithCompletion:(MNFMultipleAccountIdsCompletionHandler)completion {
    ...
    __block MNFJob *job = [MNFObject
        apiRequestWithPath:kMNFUpcomingAccountsIncluded
                 pathQuery:nil
                  jsonBody:nil
                HTTPMethod:kMNFHTTPMethodGET
                   service:MNFServiceNameUpcoming
...
+ (MNFJob *)setIncludedAccountIds:(NSString *)accountIds withCompletion:(MNFErrorOnlyCompletionHandler)completion {
    ...
    __block MNFJob *job = [MNFObject apiRequestWithPath:kMNFUpcomingAccountsIncluded
                                              pathQuery:jsonQuery
                                               jsonBody:nil
                                             HTTPMethod:kMNFHTTPMethodPUT
                                                service:MNFServiceNameUpcoming
...
- (NSDictionary *)subclassedProperties {
    return @{
        @"recurringPattern":
            [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFUpcomingRecurringPattern class]
                                                                   option:kMNFAdapterOptionNoOption],
        @"comments": [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFUpcomingComment class]
                                                                            option:kMNFAdapterOptionNoOption],
        @"reconcileScores":
            [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFUpcomingReconcileScore class]
                                                                   option:kMNFAdapterOptionNoOption],
        @"details": [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFUpcomingDetails class]
                                                                           option:kMNFAdapterOptionNoOption]
    };
}
