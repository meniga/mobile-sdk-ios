...
- (MNFJob *)saveWithCompletion:(MNFErrorOnlyCompletionHandler)completion {
    ...
    NSString *path = [NSString stringWithFormat:@"%@/%@%@/%@",
                                                kMNFApiPathTransactions,
                                                [self.transactionId stringValue],
                                                kMNFTransactionsComments,
...
- (NSString *)description {
    return [NSString
        stringWithFormat:@"Comment %@ identifier: %@, personId: %@, comment: %@, createdDate: %@, modifiedDate: %@",
                         [super description],
                         self.identifier,
                         self.personId,
                         self.comment,
