 ...
 */
+(MNFJob*)createTransactionWithDate:(NSDate*)date text:(NSString*)text amount:(NSNumber*)amount categoryId:(NSNumber*)categoryId setAsRead:(NSNumber*)setAsRead completion:(nullable MNFTransactionCompletionHandler)completion;
 ...
 */
+(MNFJob*)deleteTransactions:(NSArray <MNFTransaction*> *)transactions withCompletion:(nullable MNFErrorOnlyCompletionHandler)completion;
