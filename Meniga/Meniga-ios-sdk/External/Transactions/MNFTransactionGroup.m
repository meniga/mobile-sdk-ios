...
-(NSString*)description {
    return [NSString stringWithFormat:@"Transaction group %@ transactions: %@, sum: %@, groupedBy: %ld, groupId: %@",[super description],self.transactions,self.sum,(long)self.groupedBy,self.groupId];
}
