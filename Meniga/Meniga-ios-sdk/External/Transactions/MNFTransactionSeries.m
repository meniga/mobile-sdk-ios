...

{
    ...
    for (MNFTransactionFilter *filter in seriesFilter.seriesSelectors) {
        NSDictionary *dict =
            @{ @"filter": [MNFJsonAdapter JSONDictFromObject:filter option:kMNFAdapterOptionNoOption error:nil] };
    ...
    NSDictionary *jsonDict = @{
        @"transactionFilter":
            [MNFJsonAdapter JSONDictFromObject:seriesFilter.transactionFilter == nil ? [MNFTransactionFilter new]
                                                                                     : seriesFilter.transactionFilter
                                        option:kMNFAdapterOptionNoOption
                                         error:nil],
...
- (NSString *)description {
    return [NSString stringWithFormat:@"Transaction series %@ timeResolution: %@, statistics: %@, values: %@, "
...
- (NSDictionary *)subclassedProperties {
    return @{
        @"transactions": [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFTransaction class]
                                                                                option:kMNFAdapterOptionNoOption],
        @"statistics":
            [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFTransactionSeriesStatistics class]
                                                                   option:kMNFAdapterOptionNoOption],
        @"values": [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFTransactionSeriesValue class]
                                                                          option:kMNFAdapterOptionNoOption]
    };
}
