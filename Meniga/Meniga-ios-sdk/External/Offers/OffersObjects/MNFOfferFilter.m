...
- (NSDictionary *)propertyKeysMapToJson {
    return @{
        @"expiredWithCashbackOnly": @"filter.expiredWithCashbackOnly",
        @"offerIds": @"filter.offerIds",
        @"offerStates": @"filter.states",
        @"expiredWithRedemptionsOnly": @"filter.expiredWithRedemptionsOnly"
    };
}

- (NSDictionary *)propertyValueTransformers {
    return @{
        @"expiredWithCashbackOnly": [MNFNumberToBoolValueTransformer transformer],
        @"skipMeta": [MNFNumberToBoolValueTransformer transformer],
