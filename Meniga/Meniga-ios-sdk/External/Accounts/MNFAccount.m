    ...
    __block MNFJob *job = [self apiRequestWithPath:kMNFAPIPathAccounts pathQuery:nil jsonBody:nil HTTPMethod:kMNFHTTPMethodGET service:MNFServiceNameAccounts completion:^(MNFResponse*  _Nullable response) {
        ...
        if (response.error == nil) {
            if ([response.result isKindOfClass:[NSArray class]]) {
                ...
                [MNFObject executeOnMainThreadWithJob:job completion:completion parameter:accounts error:nil];
...
+(MNFJob *)fetchAccountCategoriesWithCompletion:(MNFMultipleAccountCategoriesCompletionHandler)completion {
    ...
    __block MNFJob *job = [self apiRequestWithPath:kMNFAccountCategories pathQuery:nil jsonBody:nil HTTPMethod:kMNFHTTPMethodGET service:MNFServiceNameAccounts completion:^(MNFResponse*  _Nullable response) {
...
+(MNFJob *)fetchAccountAuthorizationTypesWithCompletion:(MNFMultipleAccountAuthorizationTypesCompletionHandler)completion {
    
    __block MNFJob *job = [self apiRequestWithPath:kMNFAccountAuthorizationTypes pathQuery:nil jsonBody:nil HTTPMethod:kMNFHTTPMethodGET service:MNFServiceNameAccounts completion:^(MNFResponse*  _Nullable response) {
        ...
        if (response.error == nil) {
            ...
            if ([response.result isKindOfClass:[NSArray class]]) {
                ...
                NSArray *authorizationTypes = [MNFAccountAuthorizationType initWithServerResults:response.result];
                [MNFObject executeOnMainThreadWithJob:job completion:completion parameter:authorizationTypes error:nil];
...
+(MNFJob *)fetchAccountTypesWithCompletion:(MNFMultipleAccountTypesCompletionHandler)completion {
    ...
    __block MNFJob *job = [self apiRequestWithPath:kMNFAccountTypes pathQuery:nil jsonBody:nil HTTPMethod:kMNFHTTPMethodGET service:MNFServiceNameAccounts completion:^(MNFResponse * _Nullable response) {
...
-(MNFJob *)fetchMetadataWithCompletion:(MNFMultipleMetadataCompletionHandlers)completion {
    ...
    NSString *path = [NSString stringWithFormat:@"%@/%@/%@",kMNFAPIPathAccounts,[self.identifier stringValue],kMNFAccountMetadata];
...
-(MNFJob *)fetchMetadataForKey:(NSString *)key withCompletion:(MNFMetadataValueCompletionHandler)completion {
    ...
    NSString *path = [NSString stringWithFormat:@"%@/%@/%@/%@",kMNFAPIPathAccounts,[self.identifier stringValue],kMNFAccountMetadata,key];
    ...
    __block MNFJob *job = [[self class] apiRequestWithPath:path pathQuery:nil jsonBody:nil HTTPMethod:kMNFHTTPMethodGET service:MNFServiceNameAccounts completion:^(MNFResponse * _Nullable response) {
        ...
        if (response.error == nil) {
            ...
            if ([response.result isKindOfClass:[NSString class]]) {
                ...
                [MNFObject executeOnMainThreadWithJob:job completion:completion parameter:nil error: [MNFErrorUtils errorForUnexpectedDataOfType:[response.result class] expected:[NSString class]] ];
...
-(MNFJob *)setMetadataValue:(NSString *)value forKey:(NSString<NSCopying> *)aKey completion:(MNFErrorOnlyCompletionHandler)completion {
...
-(MNFJob *)saveWithCompletion:(MNFErrorOnlyCompletionHandler)completion {
    ...
    __block MNFJob *job = [self updateWithApiPath:path pathQuery:nil jsonBody:data httpMethod:kMNFHTTPMethodPUT service:MNFServiceNameAccounts completion:^(MNFResponse*  _Nullable response) {
...
-(MNFJob *)deleteAccountWithCompletion:(MNFErrorOnlyCompletionHandler)completion {
    ...
    __block MNFJob *job = [self deleteWithApiPath:path pathQuery:nil jsonBody:nil service:MNFServiceNameAccounts completion:^(MNFResponse*  _Nullable response) {
...
-(MNFJob *)fetchHistoryFromDate:(NSDate *)fromDate toDate:(NSDate *)toDate sortBy:(NSString *)sortBy ascending:(BOOL)ascending completion:(MNFMultipleAccountHistoryCompletionHandler)completion {
    
    [completion copy];
    
    if (![sortBy isEqualToString:@"Balance"] && ![sortBy isEqualToString:@"BalanceDate"] && sortBy != nil) {
        
        [MNFObject executeOnMainThreadWithCompletion:completion withParameters:nil and:[MNFErrorUtils errorWithCode:kMNFErrorInvalidParameter message:@"Sorting descriptor is incorrect. Please use \"Balance\" or \"BalanceDate\" to indicate which parameter to sort by."]];
        MNFJob *job = [MNFJob jobWithError:[MNFErrorUtils errorWithCode:kMNFErrorInvalidParameter message:@"Sorting descriptor is incorrect. Please use \"Balance\" or \"BalanceDate\" to indicate which parameter to sort by."]];
    ...
    NSString *path = [NSString stringWithFormat:@"%@/%@/%@",kMNFAPIPathAccounts,[self.identifier stringValue],kMNFAccountHistory];
    ...
    NSMutableDictionary *jsonQuery = [NSMutableDictionary dictionaryWithObjectsAndKeys:dateFrom,@"dateFrom",dateTo,@"dateTo", nil];
    if (sortBy != nil) {
        [jsonQuery setObject:sortBy forKey:@"sort"];
    }
    
    __block MNFJob *job = [[self class] apiRequestWithPath:path pathQuery:[jsonQuery copy] jsonBody:nil HTTPMethod:kMNFHTTPMethodGET service:MNFServiceNameAccounts completion:^(MNFResponse * _Nullable response) {
        ...
        if (response.error == nil) {
            ...
            if ([response.result isKindOfClass:[NSArray class]]) {
                ...
                [MNFObject executeOnMainThreadWithJob:job completion:completion parameter:historyEntries error:nil];
...
-(NSString*)description {
    return [NSString stringWithFormat:@"Account %@ identifier: %@, accountIdentifier: %@, accountTypeId: %@, balance: %@", [super description], self.identifier, self.accountIdentifier, self.accountTypeId, self.balance];
}
...
-(NSDictionary*)propertyValueTransformers {
    ...
    return @{@"lastUpdate":[MNFBasicDateValueTransformer transformer],
