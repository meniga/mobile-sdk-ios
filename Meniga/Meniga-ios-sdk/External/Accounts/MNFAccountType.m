...
+ (MNFJob *)fetchAccountTypesWithOrganizationId:(NSNumber *)organizationId
                                     completion:(MNFMultipleAccountTypesCompletionHandler)completion {
    [completion copy];
...
- (NSDictionary *)jsonKeysMapToProperties {
    return @{ @"identifier": @"id", @"accountDescription": @"description" };
}
...
- (NSDictionary *)subclassedProperties {
    return @{
        @"importAccountConfiguration":
            [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFImportAccountConfiguration class]
...
- (NSString *)description {
    return [NSString
        stringWithFormat:@"Realm account type %@ identifier: %@, accountDescription: %@, accountType: %@, name: %@",
                         [super description],
                         self.identifier,
                         self.accountDescription,
                         self.accountCategory,
                         self.name];
}
