...
+ (MNFJob *)fetchMerchantsWithIds:(NSArray<NSNumber *> *)identifiers
                       completion:(MNFMultipleMerchantsCompletionHandler)completion {
    ...
    __block MNFJob *job = [self
        apiRequestWithPath:kMNFApiPathMerchants
                 pathQuery:jsonQuery
                  jsonBody:nil
                HTTPMethod:kMNFHTTPMethodGET
                   service:MNFServiceNameMerchants
...
- (NSString *)description {
    return [NSString
        stringWithFormat:@"Merchant %@ identifier: %@, address: %@, categoryScores: %@, childMerchants: %@, "
                         @"detectedCategory: %@, directoryLink: %@, email: %@, merchantIdentifier: %@, "
                         @"masterIdentifier: %@, merchantCategoryIdentifier: %@, name: %@, offersLink: %@, parentId: "
                         @"%@, parentMerchant: %@, parentName: %@, publicIdentifier: %@, telephone: %@, webpage: %@",
                         [super description],
                         self.identifier,
                         self.address,
                         self.categoryScores,
                         self.childMerchants,
                         self.detectedCategory,
                         self.directoryLink,
                         self.email,
                         self.merchantIdentifier,
                         self.masterIdentifier,
                         self.merchantCategoryIdentifier,
                         self.name,
                         self.offersLink,
                         self.parentId,
                         self.parentMerchant,
...
- (NSDictionary<NSString *, MNFJsonAdapterSubclassedProperty *> *)subclassedProperties {
    return @{
        @"address": [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFMerchantAddress class]
                                                                           option:kMNFAdapterOptionNoOption],
        @"childMerchants": [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFMerchant class]
                                                                                  option:kMNFAdapterOptionNoOption],
        @"categoryScores": [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFCategoryScore class]
                                                                                  option:kMNFAdapterOptionNoOption],
        @"detectedCategory": [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFCategoryScore class]
                                                                                    option:kMNFAdapterOptionNoOption],
        @"parentMerchant": [MNFJsonAdapterSubclassedProperty subclassedPropertyWithClass:[MNFMerchant class]
                                                                                  option:kMNFAdapterOptionNoOption]
    };
}
