...
+ (MNFJob *)fetchFromDate:(NSDate *)from
          ...
          typeIdentifiers:(NSString *)typeIdentifier
               completion:(MNFMultipleUserEventsCompletionHandler)completion {
    [completion copy];
    ...
    __block MNFJob *job = [self
        apiRequestWithPath:kMNFApiPathUserEvents
...
+ (MNFJob *)subscribeToUserEvents:(NSArray<NSString *> *)userEventTypeIdentifiers
    ...
    __block MNFJob *job = [self apiRequestWithPath:kMNFUserEventsSubscription
                                         pathQuery:nil
                                          jsonBody:jsonData
...
+ (MNFJob *)unsubscribeFromUserEvents:(NSArray<NSString *> *)userEventTypeIdentifiers
                            onChannel:(NSString *)channelName
                           withReason:(NSString *)unsubscriptionReason
...
+ (MNFJob *)fetchEventTypesWithCompletion:(void (^)(NSArray<NSString *> *_Nullable, NSError *_Nullable))completion {
    ...
    __block MNFJob *job = [self
        apiRequestWithPath:kMNFUserEventTypes
                 pathQuery:nil
                  jsonBody:nil
                HTTPMethod:kMNFHTTPMethodGET
                   service:MNFServiceNameUserEvents
